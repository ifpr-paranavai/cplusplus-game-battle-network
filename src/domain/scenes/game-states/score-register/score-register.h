...
namespace Game
{
  ...
  public:
    ...
    const int letterYPosition = Config::WINDOW_HEIGHT / 2 - Global::adaptersInstance.renderer->getTextHeight("A") / 2;
    const int letterWidth = Global::adaptersInstance.renderer->getTextWidth("A");
